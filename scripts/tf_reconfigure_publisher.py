...
TfParameterConfig.max['x'] = 5
TfParameterConfig.max['y'] = 5
TfParameterConfig.max['z'] = 5
TfParameterConfig.min['x'] = -5
TfParameterConfig.min['y'] = -5
TfParameterConfig.min['z'] = -5
TfParameterConfig.max['yaw'] = 3.1415926
TfParameterConfig.min['yaw'] = -3.1415926
TfParameterConfig.max['pitch'] = 3.1415926
TfParameterConfig.min['pitch'] = -3.1415926
TfParameterConfig.max['roll'] = 3.1415926
TfParameterConfig.min['roll'] = -3.1415926
